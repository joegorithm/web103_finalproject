...
The team pulled together and got the work done. 

### 2. What were some challenges your group faced in this unit?

The ability to make time to collaborate on this project. 

### Did you finish all of your tasks in your sprint plan for this week? If you did not finish all of the planned tasks, how would you prioritize the remaining tasks on your list?

The only tasks that got completed is adding the items to the GitHub issues page. We will need to quickly implement the required tasks. 

### Which features and user stories would you consider “at risk”? How will you change your plan if those items remain “at risk”?

The entire project is 'at risk', but we believe that we can still get it done. 

### 5. What additional support will you need in upcoming units as you continue to work on your final project?

The additional support that would be needed is some extra time during the class meetings to help facilitate assignment of goals and expectations. 
